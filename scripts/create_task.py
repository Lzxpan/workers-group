...
def create_task(title: str, request: str) -> dict:
    ...
    return {
        ...
        "non_goals": [],
        "constraints": ["No CLOSED without independent QA PASS and readable evidence"],
        "assumptions": [],
...
def main() -> int:
    ...
    try:
        charter = create_task(args.title, args.request_file.read_text(encoding="utf-8"))
