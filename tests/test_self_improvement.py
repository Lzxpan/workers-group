...
class SelfImprovementStructureTests(WorkersGroupTestCase):
    ...
    def test_codex_features_list_accepts_project_config_when_cli_exists(self):
        ...
        result = subprocess.run(
            [executable, "features", "list"], cwd=ROOT, text=True, encoding="utf-8",
    ...
    def test_improvement_proposal_schema_matches_cli_contract_and_real_template(self):
        ...
        base = {
            ...
            "testEvidence": [".agents/skills/orchestrating-workers-group/tests/test_skill_doctor.py"],
            "qaEvidence": [".agents/skills/orchestrating-workers-group/tests/test_self_improvement.py"],
            "qaVerdict": "PASS",
            "bossReview": "APPROVED",
            "version": "1.0.1",
